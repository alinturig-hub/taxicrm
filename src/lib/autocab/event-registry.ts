...
import { processBookingDispatchAcceptedWebhook } from "@/lib/autocab/process-booking-dispatch-accepted";
import { processBookingArrivedWebhook } from "@/lib/autocab/process-booking-arrived";
import { processBookingPOBWebhook } from "@/lib/autocab/process-booking-pob";
import { processBookingCompleteWebhook } from "@/lib/autocab/process-booking-complete";
...
const eventDefinitions = [
  ...
  },
  {
    ...
    createTimeline: true,
    aiRelevant: true,
    handler: processBookingDispatchAcceptedWebhook,
  },
  {
    ...
    createTimeline: true,
    aiRelevant: true,
    handler: processBookingArrivedWebhook,
  },
  {
    ...
    createTimeline: true,
    aiRelevant: true,
    handler: processBookingPOBWebhook,
  },
  {
    ...
    createTimeline: true,
    aiRelevant: true,
    handler: processBookingCompleteWebhook,
  },
  {
    ...
    createTimeline: true,
    aiRelevant: true,
    handler: processBookingNoFareWebhook,
  },
  {
    ...
    createTimeline: true,
    aiRelevant: true,
    handler: processBookingCancelledWebhook,
  },
  {
